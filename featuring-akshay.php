...
<strong><h3 style="margin-left:30px">Can you tell me about your research interests and focus?</h3></strong>
<div style="margin-left:30px">
My research focus is broadly on improving the capability of LP-WAN clients. LP-WAN is a technology that was envisioned with the capability to enable large-scale long distance wireless connectivity to battery-powered sensors in smart-cities and farms. Unfortunately, much of the touted attractive points - specifically 10 year battery life, 10 km range, 10000 sensors connected to a single base station - are infeasible in the urban landscape due to wireless impairments such as obstructions, interferences, etc. My research focuses on pushing these limits of clients' capabilities by pulling functionality from the clients to the more powerful base stations and pushing it to the cloud. Towards this, my first project <a href="charm.html">Charm</a> enabled the capability to sparsely detect and send these clients' signals to the cloud. We built on this infrastructure to develop solutions for automated frequency configuration (<a href="chime.html">Chime</a>), retrieving information at scale (<a href="quail.html">QuAiL</a>), authentication (<a href="dliot.html">DLforIoT</a>), tracking LP-WAN enabled UAVs (<a href="https://dl.acm.org/doi/10.1145/3241539.3267747">LoRaTilt</a>) and getting energy-efficient aggregates (<a href="joltik.html">Joltik</a>) from these clients. These projects are compatible with the same backbone framework enabling upto 8x longer battery life, 6-7x larger range, and 2-3x better accuracy from these clients. In addition to my focus on LP-WAN clients, I have also explored the area of full-duplex radios demonstrating the first bidirectional full-duplex mmWave link (<a href="mmfd.html">mmFD</a>).
<br />
...
<strong><h3 style="margin-left:30px">What are the research accomplishments that you are most proud of?</h3></strong>
<div style="margin-left:30px">
...
<strong><h3 style="margin-left:30px">Can you tell me about the work culture and environment at CMU?</h3></strong>
<div style="margin-left:30px">
...
<strong><h3 style="margin-left:30px">Can you share a little known fact about yourself?</h3></strong>
<div style="margin-left:30px">
